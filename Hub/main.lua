...
local Window = Library.CreateLib("DxrkestCo's Hub", "Sentinel")
local Tab = Window:NewTab("Epic Minigames")
local Section = Tab:NewSection("Epic Minigames")
Section:NewButton("Epic Minigames", "Click to execute", function()
...
local Section = Tab:NewSection("BrookHell (click to execute)")
Section:NewButton("BrookHeaven", "HELLLLLLL", function() 
       loadstring(game:HttpGet("https://raw.githubusercontent.com/IceMael7/NewIceHub/main/Brookhaven"))()
end)
local Tab = Window:NewTab("Another")
local Section = Tab:NewSection("Admin/Hub (click to execute)")
Section:NewButton("Infinite Yield", "Admin", function() 
        loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'))()
end)
Section:NewButton("Owl Hub", "Owl", function() 
        loadstring(game:HttpGet('https://raw.githubusercontent.com/CriShoux/OwlHub/master/OwlHub.txt'))()
end)
local Section = Tab:NewSection("Another troll script (click to execute)")
Section:NewButton("One Punch Man", "Must be R6 to success", function() 
        loadstring(game:HttpGet("https://raw.githubusercontent.com/LuaQax/WTF/main/OnePunchMan/Main/main.lua"))()
end)
Section:NewButton("Internal UI", "Click to execute", function() 
